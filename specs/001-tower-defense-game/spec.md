...
- **FR-001**: System MUST display a game area with a central wall that has visible HP and level indicators (Level 1: starts at 400 HP)
- **FR-002**: System MUST spawn enemies from two directions that move toward the wall along defined paths (Level 1: single enemy every 3 seconds)
...
- **FR-004**: System MUST allow wall upgrades using Blue resources that increase wall level, maximum HP, and visual appearance (Level 1 base cost: 50 Blue)
- **FR-005**: System MUST provide healing functionality using Green resources that restores current HP up to maximum (Level 1 base cost: 30 Green)
- **FR-006**: System MUST allow Yellow resource upgrades that increase generation rates for any resource type (Level 1 base cost: 40 Yellow per upgrade)
